...
public class PermissionUtil {
     ...
     */
    public static boolean getExternalStoragePermissions(Activity activity, int requestCode) {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getCameraPermissions(Activity activity, int requestCode) {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getAudioPermissions(Activity activity, int requestCode) {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getLocationPermissions(Activity activity, int requestCode) {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getContactsPermissions(Activity activity, int requestCode) {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getSendSMSPermissions(Activity activity, int requestCode) {
     ...
     * @return 是否已经获取权限，没有自动申请
     */
    public static boolean getCallPhonePermissions(Activity activity, int requestCode) {
    ...
    public static void onRequestPermissionsResult(int requestCode, String[] permissions,
                                                  int[] grantResults, OnRequestPermissionsResultCallbacks callBack) {
